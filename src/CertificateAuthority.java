...
public class CertificateAuthority {
    ...
    /**
     * Generates the certificate signed by the CertificateAuthority using x.509 format
    ...
    public static X509Certificate createCertificate(String senderName, PublicKey senderPubKey) throws Exception {
        ...
        KeyStore.PrivateKeyEntry privKeyEntry = (KeyStore.PrivateKeyEntry) ks.getEntry("CertificateAuthority", protectionParam);
    ...
    /**
     * Method is used to generate the self-signed certificate need for the key store. Can only be used by the CertificateAuthority.
    ...
    /**
     * Reads in the CertificateAuthority public key file, converts the bytes to a public key adn returns the public key
     * @return CertificateAuthority public key
     * @throws Exception
     */
    ...
    public static void main(String[] args) throws Exception {
        ...
        PrivateKey privateKey = keyGen.getPrivate();
        PublicKey publicKey = keyGen.getPublic();
        ...
        keyStore.setEntry("CertificateAuthority", AuthorityPrivKey, protectionParam);
